# =============================================================
# CTV_SETUP.ps1 - CTV Trading Platform - Complete Setup  v1.7
...
# Build ctv_files hash table - all .py files in C:\CTV
$ctvFiles = @{}
Get-ChildItem -Path "C:\CTV" -Filter "*.py" -File | ForEach-Object {
    $ctvFiles[$_.Name] = @{
        path   = $_.FullName
